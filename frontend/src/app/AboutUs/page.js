...
function TeamCard({ name, role, description, image }) {
  return (
...
function WhyCard({ title, description, icon }) {
  return (
    ...
    <div className="min-h-screen bg-gray-100 font-poppins">
      ...
      <main className="container mx-auto p-8 space-y-16">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-8">{stats.map((stat, idx) => <StatItem key={idx} {...stat}/>)}
          </div>
        </section>
